...
public class Night10_02everybody extends AppCompatActivity {
    private static MediaPlayer mp;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_night10_02);

        mp = MediaPlayer.create(this, R.raw.night10_02_narrator);
        mp.setLooping(false); // 반복 방지
        mp.start();

        Button button=findViewById(R.id.button10_02);
