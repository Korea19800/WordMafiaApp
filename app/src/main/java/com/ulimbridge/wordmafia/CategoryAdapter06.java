...
public class CategoryAdapter06 extends BaseAdapter {
    ...
    // 내가 PlayerData99 ArrayList만든것처럼 얘도 CategoryItem갖고 ArrayList 만듬 + 밑의 생성자 private이였던거 public으로 고침 괜찮나?(왜냐하면 CategorySelection06에서 소환하기 위해
    public ArrayList<CategoryItem06> listViewItemList = new ArrayList<CategoryItem06>() ;

    // CategoryAdapter의 생성자
    ...
    // 1. 밑의 메소드가 Adapter로부터 데이터를 받아와 화면에 출력시키는 메소드임!
    @Override
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // 1. TextView를 inflate된 category_item06에서 찾아줌
